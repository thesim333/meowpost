        ...
        <form action="POST" action="{{ route('agreeTerms') }}">
            ...
            <div class="block mt-4">
                <label for="agree" class="inline-flex items-center">
                    <input id="agree" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="agree">
